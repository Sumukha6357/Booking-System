...
import { Search, LayoutDashboard, User, Globe, Wallet, ShieldCheck, Heart, Bell, Gift, Calendar, MessageSquare } from "lucide-react";
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-canvas text-ink selection:bg-accent/30">
      <div className="md:grid md:grid-cols-[280px_1fr]">
        <aside className="relative flex flex-col border-r border-border bg-surface-low/50 p-6 backdrop-blur-xl max-md:hidden">
